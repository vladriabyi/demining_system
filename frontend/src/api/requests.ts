...
export const getRequests       = () =>
  client.get<DeminingRequest[]>("/requests/").then(r => r.data)

export const getDashboardStats = () =>
  client.get<DashboardStats>("/requests/stats").then(r => r.data)

export const getRequest        = (id: number) =>
  client.get<DeminingRequest>(`/requests/${id}`).then(r => r.data)

export const createRequest     = (data: RequestCreate) =>
  client.post<DeminingRequest>("/requests/", data).then(r => r.data)

export const updateRequest     = (id: number, data: RequestUpdate) =>
  client.patch<DeminingRequest>(`/requests/${id}`, data).then(r => r.data)
